...
DEFAULT_STRATEGIES = {
    ...
    "mm_tma_transposed_direct": ["default", "default", "default"],
    "mm_warp_specialized_tma": ["default", "default", "default"],
    "mv": ["align32", "align32"],
    "mul": ["align32", "default"],
...
OP_KEY_ORDERS = {
    ...
    "mm_tma_transposed_direct": ["M", "N", "K"],
    "mm_warp_specialized_tma": ["M", "N", "K"],
    "mv": ["M", "N"],
